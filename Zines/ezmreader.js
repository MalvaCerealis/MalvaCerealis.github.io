...
/*  
    ...
    8: 64 pages
        Micro
*/
 const BGCOLOR = '#e9dcc9'; // Change this hex value to set the background color. Remember to keep the quotes!
const ALT = 'Zine of photos Ive taken. FrontCover: Mitski singing, FrontInside:Julia Jacklin playing guitar, Page 1:A deer in a shallow stream observed from above, Page 2:Topright:Picture of me at night behind behind railing staring at the camera. Bottomleft:afterimage of me moving towards camera in same location.Page 3:A closeup of a brown frog, Page 4: A contorted, rusted signpost aligned horizontally with a tree in the background, Page 5:A winter night photo of a road-sign reading SENIORS with a picture of a person crossing above it. The sign is very bright because it is reflecting the light from the cameras flash back at it. There are some trees in the background with snow lightly coating them, and snowfall appears as small white dots littering the foreground and background'; // Change this to a plaintext copy or description of your content to make it visible to screen-readers
